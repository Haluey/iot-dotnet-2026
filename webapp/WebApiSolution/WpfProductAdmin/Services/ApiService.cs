...
namespace WpfProductAdmin.Services
{
    public class ApiService
    {
        ...
        //private readonly string serviceUrl = "http://localhost:5145/api/products";    // 최초 개발용 API
        private readonly string serviceUrl = "http://localhost:8080/api/products";  // 도커배포 API

        // 전체 조회 GET http://localhost:5145/api/products
        ...
        // 한건 저장 POST http://localhost:5145/api/products
        ...
        // 한 건 가져오기 GET http://localhost:5145/api/products/id
        ...
        // 한 건 수정하기 PUT http://localhost:5145/api/products/id
        ...
        // 한 건 삭제하기 DELETE http://localhost:5145/api/products/id
