...
namespace WpfProductAdmin
{
    ...
    public partial class ProductWindow : MetroWindow
    {
        ...
        public ProductWindow()  // 생성자 하나 더 만드는게 아닌 null값 받아서 해도됨
        {
            InitializeComponent();
            ...
            BtnDelete.Visibility = Visibility.Hidden;   // 신규등록일 때 삭제버튼 숨기기
        }
        ...
        {
            var confirm = await this.ShowMessageAsync("삭제", $"[{_product.ProductName}] 상품을\n삭제하시겠습니까?", 
