    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateProduct(Product product)
        {
            ...
            string query =
                ...
                """;    // PK가 AutoIncrement이면 LAST_INSERT_ID()로 새로 추가된 PK를 가져와야 함
            ...
            product.CreatedAt = DateTime.Now;   // DB에서 안받는 이유. DB 저장시간과 거의 동일

            // 정상적으로 Post가 발생해서 데이터 생성됨. 생성된 상품으로 URL에서 다시 조회할 수 있음
