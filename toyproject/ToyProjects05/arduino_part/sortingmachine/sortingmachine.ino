...
// 상수 선언부
#define PIN_DC_DIRECTION 12   // DC모터 방향을 정하는 핀
#define PIN_DC_SPEED 10   // DC모터 속도를 정하는 핀
...
void setup() {
  ...
  servo.write(5);   // 초기 각도 재설정. 최초 연결시 바 각도마다 다르므로 따로 설정    
  delay(500);
