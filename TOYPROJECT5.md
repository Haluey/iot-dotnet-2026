...
- MQTT 소스 + 시리얼 통신 소스 + 양방향 통신 - [소스](./toyproject/ToyProjects05/raspberrypi_part/data_interface.py)
...
- M2MqttUnity 설치
    ...
    - 압축 해제한 Assets 폴더를 Unity 프로젝트 Assets에 복사

    ![alt text](image-314.png)

- M2MqttUnity_Test Scene 사용 테스트
