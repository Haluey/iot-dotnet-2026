...
{
    // [SerializeField] private == public과 거의 동일
    // UI 요소/오브젝트를 Inspector에서 연결하기 위한 직렬화 필드
    // [SerializeField] private은 유니티에디터에서만 public은 어디서나 
    [SerializeField] private TMP_Text labelOverlay; // 현재상태 표시 오버레이 텍스트
    [SerializeField] private TMP_Text labelApplicationMode; // 애플리케이션 모드(시뮬레이션/클라우드)표시 텍스트
    ...
    public void ToggleLocate()
    {
        ...
        // 메시지 컨테이너 활성화 토글(_showLocator가 true면 활성화, false면 비활성화)
